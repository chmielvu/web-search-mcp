...
- `code_search` has no public mode switch. Its deterministic planner selects and combines lexical, symbol, regex, semantic, repository-discovery, and documentation channels from the query and supplied scopes.
