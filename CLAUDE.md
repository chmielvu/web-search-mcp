...
Kindly Web Search MCP Server — multi-provider web search (SearXNG/Tavily/Brave/Jina) with RRF merge, specialized content extraction, and semantic caching. Designed for AI coding assistants (Claude Code, Codex, Cursor, etc.).
