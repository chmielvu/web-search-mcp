...
This project is indexed by GitNexus as **web-search-mcp** (9822 symbols, 17030 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
