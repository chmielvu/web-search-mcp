...
This project is indexed by GitNexus as **web-search-mcp** (7358 symbols, 12473 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
