...
This project is indexed by GitNexus as **web-search-mcp** (7026 symbols, 11951 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
