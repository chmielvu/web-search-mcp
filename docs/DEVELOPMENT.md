...
│   ├── __init__.py        # Provider registry and canonical search exports
│   ├── provider_execution.py # Provider-level telemetry and budget tracking
│   ├── query_execution.py # Multi-provider orchestration and merge telemetry
