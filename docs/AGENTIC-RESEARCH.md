...
- `AGENTIC_RESEARCH_GEMINI_FALLBACK_MODEL`
- `AGENTIC_RESEARCH_HF_ROUTER_BASE_URL`
- `AGENTIC_RESEARCH_HF_FALLBACK_MODEL`
- `AGENTIC_RESEARCH_BASE_URL`
- `AGENTIC_RESEARCH_TEMPERATURE`
- `AGENTIC_RESEARCH_TIMEOUT_SECONDS`
- `AGENTIC_RESEARCH_MAX_RETRIES`
- `AGENTIC_RESEARCH_QUICK_RUN_LIMIT`
- `AGENTIC_RESEARCH_NORMAL_RUN_LIMIT`
- `AGENTIC_RESEARCH_DEEP_RUN_LIMIT`
- `AGENTIC_RESEARCH_QUICK_TIMEOUT_SECONDS`
- `AGENTIC_RESEARCH_NORMAL_TIMEOUT_SECONDS`
- `AGENTIC_RESEARCH_DEEP_TIMEOUT_SECONDS`
...
4. `gemini-3.5-flash` through the Gemini API when `GEMINI_API_KEY` is set
...
- Set `LANGFUSE_PUBLIC_KEY`, `LANGFUSE_SECRET_KEY`, `LANGFUSE_BASE_URL` (or the  equivalents for convenience). If you already have `LANGFUSE_MCP_AUTH_HEADER` from the Langfuse MCP config, the runtime now decodes it and reuses the contained project keys automatically.
