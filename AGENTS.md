...
This project is indexed by GitNexus as **web-search-mcp** (9587 symbols, 16613 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
